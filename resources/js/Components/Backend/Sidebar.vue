<template>
    <section>
        <div
            class="h-screen fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0"
        >
            <div class="flex items-center justify-center mt-8">
                <div class="flex items-center">
                    ...
                    <span class="text-white text-2xl mx-2 font-semibold">V-Dashboard</span>
                </div>
            </div>
